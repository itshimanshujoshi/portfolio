            ...
            >
              <div
                className={`relative bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 transition-all duration-300 cursor-pointer ${
                  hoveredTech === tech.name
                    ? "transform -translate-y-2 shadow-2xl shadow-teal-500/30 border-teal-500/50 bg-white/10"
              ...
              >
                ...
                <div className="absolute -top-2 -right-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <span className="bg-teal-500 text-white text-xs px-2 py-1 rounded-full shadow-lg">
                    {tech.category}
                  </span>
                </div>
                ...
                {/* Glow Effect */}
                <div
                  className={`absolute inset-0 rounded-2xl bg-gradient-to-br from-teal-500/20 to-pink-500/20 opacity-0 transition-opacity duration-300 -z-10 blur-xl ${
